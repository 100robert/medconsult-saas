...
export default function LoginPage() {
  ...
  const features = [
    { icon: Stethoscope, text: '500+ Médicos Certificados' },
    { icon: Shield, text: 'Datos 100% Seguros' },
    { icon: Clock, text: 'Atención 24/7' },
    { icon: Star, text: '4.9 Calificación' },
  ];
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-xl flex items-center justify-center border border-white/30 shadow-glow">
            ...
            >
              ...
              <span className="text-sm font-medium">La plataforma #1 en telemedicina</span>
            </motion.div>
            ...
            >
              Conecta con especialistas certificados y recibe atención médica de calidad desde cualquier lugar.
            </motion.p>
            ...
            >
              <div>
                ...
                <div className="text-white/60 text-sm">Pacientes Felices</div>
              </div>
              <div>
            ...
            <div className="glass-card-light p-8 md:p-10 max-w-md mx-auto">
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/80 text-gray-500 rounded-full">O continúa con</span>
                </div>
              </motion.div>
