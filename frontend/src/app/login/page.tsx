        ...
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="glass-card-light p-8 md:p-10 max-w-md mx-auto">
              ...
              >
                <motion.button 
                  className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-white/80 border-2 border-gray-100 rounded-2xl hover:bg-white hover:border-gray-200 hover:shadow-lg transition-all font-medium text-gray-700"
