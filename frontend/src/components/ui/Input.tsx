  ...
  (
    ...
    const variants = {
      default: `
        ...
        focus:border-[#667eea] focus:ring-4 focus:ring-[#667eea]/10
      ...
      glass: `
        ...
        focus:shadow-[0_0_20px_rgba(102,126,234,0.3)]
      `,
      'glass-light': `
        bg-white/90 backdrop-blur-xl border-2 border-[#667eea]/10
        focus:border-[#667eea]/50 focus:ring-4 focus:ring-[#667eea]/10
          ...
          {leftIcon && (
            <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors ${
              variant === 'glass' 
                ...
                : 'text-gray-400 group-focus-within:text-[#667eea]'
            }`}>
              {leftIcon}
            </div>
          )}
