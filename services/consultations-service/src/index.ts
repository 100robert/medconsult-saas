// ============================================
// CONSULTATIONS SERVICE - PUNTO DE ENTRADA
// ============================================
...
app.use(
  cors({
    origin: true, // Permitir todos los orígenes en desarrollo (las peticiones vienen del gateway)
    credentials: true,
...
app.get('/', (req, res) => {
  res.status(200).json({
    message: 'MedConsult Consultations Service API',
    version: '1.0.0',
    endpoints: {
      health: '/health',
      consultas: '/consultas',
...
async function startServer() {
  try {
    ...
    const server = app.listen(PORT, () => {
      console.log('\n🚀 ============================================');
      console.log(`✅ Consultations Service corriendo en modo ${NODE_ENV}`);
